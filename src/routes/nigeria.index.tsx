...
export const Route = createFileRoute("/nigeria/")({
  head: () => ({
    meta: [
      { title: "Buy & sell near you — every state in Nigeria | 080Bay" },
      {
        name: "description",
        content:
          "Browse 080Bay listings by state, city, town and campus — Lagos, Abuja, Kano, Port Harcourt, UNILAG, ABU Zaria and every corner of Nigeria.",
      },
      { property: "og:title", content: "Buy & sell near you — every state in Nigeria" },
      {
        property: "og:description",
        content: "Find items for sale in your village, town, city or campus on 080Bay.",
      },
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">
          080Bay covers all 36 states and the FCT — every village, town, city, university and
